 ...
 * 
 * Approach:
 * 1. In this approach, DFS will be used. 
 ...
 *
 *  Other Approaches : LeetCode_3372_MaximizeTheNumberOfTargetNodesAfterConnectingTreeI_ApproachBFS.java
 */
...
public class LeetCode_3372_MaximizeTheNumberOfTargetNodesAfterConnectingTreesI_ApproachDFS {
    ...
    public int[] maxTargetNodes(int[][] edges1, int[][] edges2, int k) {
        ...
        int max = java.util.Collections.max(targetsInTree2);
    ...
    private int getTargets(Map<Integer, List<Integer>> adjList, int parent, int node, int k) {
       ...
       for (int neighbourNode : adjList.get(node)) {
            ...
            target += getTargets(adjList, node, neighbourNode, k  - 1);
       } 
